...
for run in range(N_RUNS):
    ...
    if MODEL == 'SVM_grid':
        ...
        class_weight = 'balanced' if CLASS_BALANCING else None
        clf = sklearn.linear_model.SGDClassifier(class_weight=class_weight, learning_rate='optimal', tol=1e-1, average=10)
        clf.fit(X_train, y_train)
        save_model(clf, MODEL, DATASET)
...
#            model.feature_selector.set_mask
    ...
    acc, kappa, f1scores = show_results(run_results, viz, label_values=LABEL_VALUES)
